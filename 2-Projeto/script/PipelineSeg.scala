...
val dataset = spark.read.option("header","true").option("inferSchema","true").csv("../dataset/dados.csv")
...
import java.io._
val writer = new BufferedWriter(new FileWriter("../output/previsoes.txt"))
